...
x_baixian=(A_cycloid(1,1)*((rp+drp-(rrp+drrp).*fi).*cos((1-ih).*ti-dsi)-(er-k1*(rrp+drrp).*fi).*cos(ih.*ti+dsi))+A_cycloid(1,2)*(-((rp+drp-(rrp+drrp).*fi).*sin((1-ih).*ti-dsi)+(er-k1*(rrp+drrp).*fi).*sin(ih.*ti+dsi))))+er;   %x坐标方程
y_baixian=(A_cycloid(2,1)*((rp+drp-(rrp+drrp).*fi).*cos((1-ih).*ti-dsi)-(er-k1*(rrp+drrp).*fi).*cos(ih.*ti+dsi))+A_cycloid(2,2)*(-((rp+drp-(rrp+drrp).*fi).*sin((1-ih).*ti-dsi)+(er-k1*(rrp+drrp).*fi).*sin(ih.*ti+dsi))));   %x坐标方程
...
curve.xfun = @(t)((A_cycloid(1,1)*((rp+drp-(rrp+drrp).*fun_fi(t)).*cos((1-ih).* t -dsi)-(er-k1*(rrp+drrp).*fun_fi(t)).*cos(ih.* t + dsi))+A_cycloid(1,2)*(-((rp+drp-(rrp+drrp).*fun_fi(t)).*sin((1-ih).* t -dsi)+(er-k1*(rrp+drrp).*fun_fi(t)).*sin(ih.* t+dsi))))+er);
curve.yfun = @(t)(A_cycloid(2,1)*((rp+drp-(rrp+drrp).*fun_fi(t)).*cos((1-ih).* t -dsi)-(er-k1*(rrp+drrp).*fun_fi(t)).*cos(ih.* t + dsi))+A_cycloid(2,2)*(-((rp+drp-(rrp+drrp).*fun_fi(t)).*sin((1-ih).* t -dsi)+(er-k1*(rrp+drrp).*fun_fi(t)).*sin(ih.* t+dsi))));
